...
void pidInit(void)
{
  ...
  pid.pid[PIDSPEED].P8    = 80;   pid.pid[PIDSPEED].I8    = 60; pid.pid[PIDSPEED].D8    =  0;
  pid.pid[PIDANGLE].P8    = 110;   pid.pid[PIDANGLE].I8    =  0; pid.pid[PIDANGLE].D8    = 50;
...
void taskMainPidLoop(timeUs_t currentTimeUs)
{
  ...
  /**** PD_angle regulator ****/
  pid.currAngle = (int16_t)attitude.values.pitch - 50;// + conf.angleTrim[CURRENT_AXIS];
